GET_AI_ACOMP1<-function(srv_sp_str="21720",max_age=10,Seas=1,FLT=2,Gender=1,Part=0,Ageerr=1,Lgin_lo=-1,Lgin_hi=-1,Nsamp=100){
  ## create sql query

  test<-paste("SELECT AI.AGECOMP_TOTAL.SURVEY_YEAR AS YEAR, \n",
    "AI.AGECOMP_TOTAL.AGE, \n",
    "SUM(AI.AGECOMP_TOTAL.AGEPOP) AS AGEPOP \n",
    "FROM AI.AGECOMP_TOTAL \n",
    "WHERE AI.AGECOMP_TOTAL.AGE        > 0 \n",
    "AND AI.AGECOMP_TOTAL.SEX          < 9 \n",
    "AND AI.AGECOMP_TOTAL.SPECIES_CODE = ", srv_sp_str," \n",
