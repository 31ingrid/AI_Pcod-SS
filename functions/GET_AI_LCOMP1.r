GET_AI_LCOMP1<-function(species="99999",bins=seq(0,109,1),bin=TRUE,SS=TRUE,seas=1,flt=3,gender=1,part=0,Nsamp=100){
  ## create sql query

test<-paste("SELECT AI.SIZECOMP_TOTAL.YEAR AS YEAR, \n ",
    "AI.SIZECOMP_TOTAL.LENGTH/10 as LENGTH, \n ",
    "AI.SIZECOMP_TOTAL.TOTAL \n ",
    "FROM AI.SIZECOMP_TOTAL \n ",
    "WHERE AI.SIZECOMP_TOTAL.SPECIES_CODE = ",species,"  \n ",
    "ORDER BY AI.SIZECOMP_TOTAL.YEAR, \n ",
    "AI.SIZECOMP_TOTAL.LENGTH \n ", sep="")
